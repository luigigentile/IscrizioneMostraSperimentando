        ...
        <div class="row">
            <div >
             ...
             <h2> La visita alla mostra puo' essere Virtuale o in Presenza </h2>
                     <p> La  <strong> visita guidata virtuale </strong> verrà effettuata tramite una videoconferenza con una nostra guida <br>
                     e puo' essere prenotata solo da Scuole/gruppi con almeno 15 persone. 
                     <br>
                     <br>
                     <span> 
              ...
              <div class="ml-5">
                <a href="#"
                    @click="virtuale"
                    class="btn btn-primary btn-lg active" ro le="button" aria-pressed="true">Virtuale
                    </a>
                    <a
                    @click="inPresenza"
